...
//要素のMoveUpとFade
$(".is-moveup").on("inview", function (event, isInView) {
  //
  if (isInView) {
...
//Move Right
$(".MoveRight").on("inview", function (event, isInView) {
  //
  if (isInView) {
...
//Move Left
$(".MoveLeft").on("inview", function (isInView) {
  //
  if (isInView) {
...
//Zoom In
$(".ZoomIn").on("inview", function (isInView) {
  //
  if (isInView) {
...
//Fade In
$(".FadeIn").on("inview", function (isInView) {
  //
  if (isInView) {
